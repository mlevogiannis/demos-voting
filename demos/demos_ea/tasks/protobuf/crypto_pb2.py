...
# source: demos_utils/protobuf/crypto.proto
...
GG = _reflection.GeneratedProtocolMessageType('GG', (_message.Message,), dict(
  DESCRIPTOR = _GG,
  __module__ = 'demos_utils.protobuf.crypto_pb2'
