...
class Election(models.Model):
	...
	def get_absolute_url(self):
		return urlresolvers.reverse('demos_abb:', args=[self.election_id])
...
class Question(models.Model):
	...
	added_com = fields.JsonField(blank=True, null=True, default=None)
	added_decom = fields.JsonField(blank=True, null=True, default=None)
	
	coins = models.CharField(max_length=HASH_LEN, blank=True, default='')
...
class Side(models.Model):
	...
	permindex = models.CharField(max_length=PERMINDEX_LEN,blank=True,default='')
...
class OptData(models.Model):
	...
	zk2 = fields.JsonField(compressed=True, blank=True, null=True, default=None)
