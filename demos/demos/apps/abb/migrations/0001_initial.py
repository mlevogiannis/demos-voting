    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('x509_cert', models.FileField(upload_to=demos.apps.abb.models.get_cert_file_path, storage=demos.common.utils.storage.PrivateFileSystemStorage(file_permissions_mode=384, directory_permissions_mode=448, location='/var/spool/demos-voting/abb'))),
                ('json_data', models.FileField(upload_to=demos.apps.abb.models.get_json_file_path, blank=True, storage=demos.common.utils.storage.PrivateFileSystemStorage(file_permissions_mode=384, directory_permissions_mode=448, location='/var/spool/demos-voting/abb'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.PositiveSmallIntegerField()),
                ('com_sum', demos.common.utils.fields.ProtoField(null=True, cls=demos.common.utils.crypto.crypto_pb2.Com, blank=True, default=None)),
                ('decom_sum', demos.common.utils.fields.ProtoField(null=True, cls=demos.common.utils.crypto.crypto_pb2.Decom, blank=True, default=None)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Task',
            fields=[
                ('election', models.OneToOneField(primary_key=True, to='abb.Election', serialize=False)),
