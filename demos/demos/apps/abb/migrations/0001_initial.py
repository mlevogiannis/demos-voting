    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('x509_cert', models.FileField(storage=demos.common.utils.storage.PrivateFileSystemStorage(location='/var/spool/demos-voting/abb', file_permissions_mode=384, directory_permissions_mode=448), upload_to=demos.apps.abb.models.get_cert_file_path)),
                ('json_data', models.FileField(storage=demos.common.utils.storage.PrivateFileSystemStorage(location='/var/spool/demos-voting/abb', file_permissions_mode=384, directory_permissions_mode=448), upload_to=demos.apps.abb.models.get_json_file_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('l_votecode', models.CharField(blank=True, max_length=16, default='')),
                ...
                ('zk2', demos.common.utils.fields.ProtoField(null=True, blank=True, cls=demos.common.utils.crypto.crypto_pb2.ZK2, default=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.PositiveSmallIntegerField()),
                ('com_sum', demos.common.utils.fields.ProtoField(null=True, blank=True, cls=demos.common.utils.crypto.crypto_pb2.Com, default=None)),
                ('decom_sum', demos.common.utils.fields.ProtoField(null=True, blank=True, cls=demos.common.utils.crypto.crypto_pb2.Decom, default=None)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Task',
            fields=[
                ('election', models.OneToOneField(to='abb.Election', serialize=False, primary_key=True)),
