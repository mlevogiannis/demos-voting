...
class AuditView(View):
    ...
    template_name = 'bulletin_board/audit.html'
    ...
    def get(self, request, *args, **kwargs):
        ...
        if normalized != election_id:
            return redirect('bulletin_board:audit', election_id=normalized)
        ...
        if not election:
            return redirect(reverse('bulletin_board:home') + '?error=id')
...
class ResultsView(View):
    ...
    template_name = 'bulletin_board/results.html'
    ...
    def get(self, request, *args, **kwargs):
        ...
        normalized = base32.normalize(election_id)
        if normalized != election_id:
            return redirect('bulletin_board:results', election_id=normalized)
