...
af = getattr(socket, settings.DEMOS_VOTING_CRYPTO_AF)
addr = settings.DEMOS_VOTING_CRYPTO_ADDR
recv_max = getattr(settings, 'DEMOS_VOTING_CRYPTO_RECV_MAX', 134217728)   # 128 MB
recv_timeout = getattr(settings, 'DEMOS_VOTING_CRYPTO_RECV_TIMEOUT', 900)   # 15 mins
