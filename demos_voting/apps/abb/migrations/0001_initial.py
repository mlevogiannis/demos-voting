...
import demos_voting.apps.abb.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cert', models.FileField(storage=demos_voting.common.utils.storage.PrivateFileSystemStorage(file_permissions_mode=384, directory_permissions_mode=448, location=b'/home/marios/demos/devel/data/abb'), upload_to=demos_voting.apps.abb.models.get_cert_file_path)),
                ('export_file', models.FileField(storage=demos_voting.common.utils.storage.PrivateFileSystemStorage(file_permissions_mode=384, directory_permissions_mode=448, location=b'/home/marios/demos/devel/data/abb'), upload_to=demos_voting.apps.abb.models.get_export_file_path, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('com', demos_voting.common.utils.fields.ProtoField(cls=demos_voting.common.utils.crypto.crypto_pb2.Com)),
                ('zk1', demos_voting.common.utils.fields.ProtoField(cls=demos_voting.common.utils.crypto.crypto_pb2.ZK1)),
                ('zk2', demos_voting.common.utils.fields.ProtoField(default=None, cls=demos_voting.common.utils.crypto.crypto_pb2.ZK2, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', demos_voting.common.utils.fields.ProtoField(cls=demos_voting.common.utils.crypto.crypto_pb2.Key)),
                ('index', models.PositiveSmallIntegerField()),
                ('options', models.PositiveSmallIntegerField()),
                ('combined_com', demos_voting.common.utils.fields.ProtoField(default=None, cls=demos_voting.common.utils.crypto.crypto_pb2.Com, null=True, blank=True)),
                ('combined_decom', demos_voting.common.utils.fields.ProtoField(default=None, cls=demos_voting.common.utils.crypto.crypto_pb2.Decom, null=True, blank=True)),
            ],
            options={
